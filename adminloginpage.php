...
<form action="admindashboard.php" method="get">
	<div class="container">
        ...
        <div class="clearfix">
            <a href="admindashboard.php?AdminName=<?php echo $row["AdminName"] ?>"><button type="submit" class="loginbtn">Login</button></a>
        </div>

    </div>
 </form>
 <div class="container">
    <a href="shoplogin.php"><button class="loginbtn">Shop Login</button></a>
 </div>
